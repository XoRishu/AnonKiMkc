...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgQAAxkBAAEIirRkNUrTJiATFM3uDQ7HdHkLpokDPAACgwEAAgGqXxZ_YlSYXyT30y8E")
        ...
        if name[0:3] == "sta":
            m = await message.reply_text(
                f"Getting your personal stats {config.MUSIC_BOT_NAME} Server."
            )
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[Telegram Media](https://t.me/Kanna_Support) ** Played {count} Times**\n\n"
                    else:
